...
router.post('/', authenticate, authorize('organizer'), eventValidators, validate, eventController.create);
router.get('/:id', authenticate, eventController.getOne);
router.put('/:id', authenticate, authorize('organizer'), eventValidators, validate, eventController.update);
